...
var parseCertificateSimple_exports = {};
__export(parseCertificateSimple_exports, {
...
module.exports = __toCommonJS(parseCertificateSimple_exports);
...
var getCircuitName = (circuitMode, signatureAlgorithm, hashFunction, domainParameter, keyLength) => {
...
var getCircuitNameOld = (circuitMode, signatureAlgorithm, hashFunction) => {
  const circuit = circuitNameFromMode[circuitMode];
  if (circuit == "vc_and_disclose") {
    return "vc_and_disclose";
...
//# sourceMappingURL=parseCertificateSimple.cjs.map