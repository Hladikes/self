...
// src/utils/certificate_parsing/oidUtils.ts
var oidUtils_exports = {};
__export(oidUtils_exports, {
...
module.exports = __toCommonJS(oidUtils_exports);
...
//# sourceMappingURL=oidUtils.cjs.map