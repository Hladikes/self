...
// src/utils/certificate_parsing/index.ts
var certificate_parsing_exports = {};
__export(certificate_parsing_exports, {
...
module.exports = __toCommonJS(certificate_parsing_exports);
...
var getAuthorityKeyIdentifier2 = (cert) => {
...
function parseCertificateSimple(pem) {
  ...
  try {
    ...
    const authorityKeyIdentifier = getAuthorityKeyIdentifier2(cert);
