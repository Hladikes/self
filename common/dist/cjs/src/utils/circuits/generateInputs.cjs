...
var generateInputs_exports = {};
__export(generateInputs_exports, {
...
module.exports = __toCommonJS(generateInputs_exports);
...
function getCountryLeaf(country_by, country_to, i) {
  ...
  try {
    ...
    return (0, import_poseidon_lite2.poseidon6)(country);
  } catch (err) {
...
//# sourceMappingURL=generateInputs.cjs.map