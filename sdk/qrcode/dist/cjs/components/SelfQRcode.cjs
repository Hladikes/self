...
var SelfQRcode_exports = {};
__export(SelfQRcode_exports, {
  SelfQRcode: () => SelfQRcode,
  SelfQRcodeWrapper: () => SelfQRcodeWrapper
});
module.exports = __toCommonJS(SelfQRcode_exports);
var import_common = require("@selfxyz/common");
var import_lottie_react = __toESM(require("lottie-react"), 1);
...
var SelfQRcodeWrapper = (props) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement(SelfQRcode, { ...props });
};
var SelfQRcode = ({
  selfApp,
  onSuccess,
  onError,
  type = "websocket",
  websocketUrl = import_common.WS_DB_RELAYER,
  size = 300,
  darkMode = false
}) => {
  const [proofStep, setProofStep] = (0, import_react2.useState)(QRcodeSteps.WAITING_FOR_MOBILE);
  const [sessionId, setSessionId] = (0, import_react2.useState)("");
  const socketRef = (0, import_react2.useRef)(null);
  (0, import_react2.useEffect)(() => {
    setSessionId((0, import_uuid.v4)());
  }, []);
  (0, import_react2.useEffect)(() => {
  ...
  const renderProofStatus = () => /* @__PURE__ */ import_react2.default.createElement("div", { style: containerStyle }, /* @__PURE__ */ import_react2.default.createElement("div", { style: ledContainerStyle }, /* @__PURE__ */ import_react2.default.createElement(LED_default, { connectionStatus: proofStep })), /* @__PURE__ */ import_react2.default.createElement("div", { style: qrContainerStyle(size) }, (() => {
    switch (proofStep) {
      case QRcodeSteps.PROOF_GENERATION_STARTED:
      case QRcodeSteps.PROOF_GENERATED:
        return /* @__PURE__ */ import_react2.default.createElement(import_react_spinners.BounceLoader, { loading: true, size: 200, color: "#94FBAB" });
      case QRcodeSteps.PROOF_GENERATION_FAILED:
        return /* @__PURE__ */ import_react2.default.createElement(
          import_lottie_react.default.default,
          {
      ...
      default:
        return /* @__PURE__ */ import_react2.default.createElement(
          ...
          {
            value: type === "websocket" ? `${import_common.REDIRECT_URL}?sessionId=${sessionId}` : (0, import_common.getUniversalLink)({
              ...selfApp,
              sessionId
            }),
            size,
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", { style: containerStyle }, renderProofStatus());
};
//# sourceMappingURL=SelfQRcode.cjs.map