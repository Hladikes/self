...
__export(src_exports, {
  ...
  MrzParseError: () => MrzParseError,
  NFCScannerScreen: () => NFCScannerScreen,
  NfcParseError: () => NfcParseError,
  OnboardingFlow: () => OnboardingFlow,
  PassportCameraScreen: () => PassportCameraScreen,
  QRCodeScreen: () => QRCodeScreen,
  SCANNER_ERROR_CODES: () => SCANNER_ERROR_CODES,
  SdkError: () => SdkError,
  SelfClientContext: () => SelfClientContext,
  SelfClientProvider: () => SelfClientProvider,
  SelfMobileSdk: () => SelfMobileSdk,
  ...
  sdkError: () => sdkError,
  useDocumentManager: () => useDocumentManager,
...
// src/errors/InitError.ts
var InitError = class extends SdkError {
...
// src/errors/LivenessError.ts
var LivenessError = class extends SdkError {
  constructor(message, options) {
...
var NFCScannerScreen = ({ onSuccess, onFailure }) => {
  ...
  const onNFCScan = (0, import_react2.useCallback)(
    async (_nfcData) => {
      try {
        onSuccess();
      } catch (error) {
...
var OnboardingFlow = ({ external, setDocument, PassportCamera, NFCScanner }) => {
  const [mrzData, setMrzData] = (0, import_react3.useState)(null);
  const client = useSelfClient();
  const handleMRZDetected = (0, import_react3.useCallback)(
    async (mrzData2) => {
      try {
...
var SelfMobileSdk = ({ config, adapters = {}, children }) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SelfClientProvider, { config, adapters, children });
...
var useDocumentManager = (external) => {
  ...
  const hasRegisteredDocuments = (0, import_react4.useCallback)(() => {
